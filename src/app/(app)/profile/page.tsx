...
import {
  ...
  Wrench, ShoppingBag, ChevronRight, Moon, Zap
} from "lucide-react";
  ...
  return (
    <div className="space-y-4 pt-2 pb-4">
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-cyan-500/50 via-violet-500/50 to-blue-500/50" />
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="relative flex-shrink-0">
            ...
            <button onClick={() => fileRef.current?.click()}
              className="absolute -bottom-1 -right-1 w-7 h-7 rounded-xl flex items-center justify-center bg-cyan-500 text-black shadow-lg hover:bg-cyan-400 transition-colors">
              <Camera size={13} />
            </button>
          ...
          <div className="flex-1 min-w-0">
            {editing ? (
              ...
              <h2 className="text-white font-bold font-display text-xl">{user.full_name}</h2>
            )}
